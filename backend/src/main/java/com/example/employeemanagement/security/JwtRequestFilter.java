...
public class JwtRequestFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
      ...
      // Skip validation for third party fixed token
      if (THIRD_PARTY_FIXED_TOKEN.equals(jwt)) {
        // Set authentication for third party user without database lookup
        UsernamePasswordAuthenticationToken authenticationToken =
            new UsernamePasswordAuthenticationToken("third_party_user", null, null);
